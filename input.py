...
def create_final_answer(prompt, executed_output):
    content = f"This is the prompt by the user: '{prompt}' and this is the executed code output: '{executed_output}', please create the final answer."
...
def main():
    ...
    if st.button('Submit') and prompt and uploaded_file:
            ...
            if code_writer_response.status_code == 200:
                ...
                if code_executer_response.status_code == 200:
                    ...
                    if error:
                        ...
                        st.success(f"Executed Output: {output}")
